...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            pensoul_app::commands::pipeline::run_chapter_pipeline,
            pensoul_app::commands::pipeline::pause_pipeline,
            pensoul_app::commands::pipeline::resume_pipeline,
            pensoul_app::commands::pipeline::stop_pipeline,
            pensoul_app::commands::pipeline::get_pipeline_state,
